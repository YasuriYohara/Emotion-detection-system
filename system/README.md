...
1. Click "Choose File" to select a facial image (JPEG or PNG format)
2. Click "Detect Emotion" to process the image
3. View the predicted emotion and confidence score
4. Upload another image or close the application
